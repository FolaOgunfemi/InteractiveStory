...
/**
 * Create and hold array of Pages.
 * //Note: the final two pages do not have choices because they are the end.
 */
...
/*        pages[0].setImageId(R.drawable.page0);
    ...
    public Page getPage(int pageNumber) {
        //select the proper page. Check to make sure that we do not try to lookup a page outside of the array. If we do, go to the beginning.
